...
public class PostAccounts implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		Long id = Long.valueOf(ServletRequestUtils.getRequiredLongParameter(
				request, "id"));
		Double amount = Double.valueOf(ServletRequestUtils
				.getRequiredDoubleParameter(request, "amount"));
